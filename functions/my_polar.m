function hpol = my_polar(varargin)
    ...
    disableDefaultInteractivity(cax);
    set(hggetbehavior(cax, 'Pan'), 'Enable', false);
    set(hggetbehavior(cax, 'Zoom'), 'Enable', false);
    set(hggetbehavior(cax,'DataCursor'), 'Enable', false);
    set(hggetbehavior(cax,'Brush'), 'Enable', false);
